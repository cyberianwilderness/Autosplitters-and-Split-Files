...
update
{
    ...
    switch ((int)vars.bossIndex)
    {
        ...
        case 15: vars.currentSplitName = "Milda";            vars.expectedExp = vars.Milda_EXP;           vars.expectedGold = vars.Milda_Gold;           break;

        case 16: vars.currentSplitName = "Gaia Battler 1";   vars.expectedExp = vars.GaiaBattler1_EXP;    vars.expectedGold = vars.GaiaBattler1_Gold;    break;
        case 17: vars.currentSplitName = "Gaia Battler 2";   vars.expectedExp = vars.GaiaBattler2_EXP;    vars.expectedGold = vars.GaiaBattler2_Gold;    break;

        case 18: vars.currentSplitName = "Ruin Guard";       vars.expectedExp = vars.RuinGuard_EXP;       vars.expectedGold = vars.RuinGuard_Gold;       break;
        case 19: vars.currentSplitName = "Trinity";          vars.expectedExp = vars.Trinity_EXP;         vars.expectedGold = vars.Trinity_Gold;         break;

        case 20: vars.currentSplitName = "Baal";             vars.expectedExp = vars.Baal1_EXP;           vars.expectedGold = vars.Baal1_Gold;           break;
        case 21: vars.currentSplitName = "Hydra";            vars.expectedExp = vars.Hydra_EXP;           vars.expectedGold = vars.Hydra_Gold;           break;

        case 22: vars.currentSplitName = "Great Susano-o";   vars.expectedExp = vars.GreatSusanoo_EXP;    vars.expectedGold = vars.GreatSusanoo_Gold;    break;
        case 23: vars.currentSplitName = "Phantom Dragon";   vars.expectedExp = vars.PhantomDragon_EXP;   vars.expectedGold = vars.PhantomDragon_Gold;   break;

        case 24: vars.currentSplitName = "Gaia Battler 3";   vars.expectedExp = vars.GaiaBattler3_EXP;    vars.expectedGold = vars.GaiaBattler3_Gold;    break;
        case 25: vars.currentSplitName = "Mage King";        vars.expectedExp = vars.MageKing_EXP;        vars.expectedGold = vars.MageKing_Gold;        break;

        case 26: vars.currentSplitName = "Gaia Battler 4";   vars.expectedExp = vars.GaiaBattler4_EXP;    vars.expectedGold = vars.GaiaBattler4_Gold;    break;
        case 27: vars.currentSplitName = "Mullen";           vars.expectedExp = vars.Mullen_EXP;          vars.expectedGold = vars.Mullen_Gold;          break;

        case 28: vars.currentSplitName = "Gaia Trent";       vars.expectedExp = vars.GaiaTrent_EXP;       vars.expectedGold = vars.GaiaTrent_Gold;       break;
        case 29: vars.currentSplitName = "Gaia Armor";       vars.expectedExp = vars.GaiaArmor_EXP;       vars.expectedGold = vars.GaiaArmor_Gold;       break;
