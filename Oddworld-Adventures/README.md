...
- All runners rename it to what they prefer anyway. 
- Feel free to use my splits file (included in the repo) if you like. Feel free to rename the splits to what you like, this is what I have opted for, using the currentArea vairable I found.

| CurrentArea Value | Split Name |
| -- | ------- | 
| 1 | Paramites and Slogs
| 2 | Temple Entry
| 3-8 | Paramonia Temple (Trials 1 to 6) |
| 9 | Paramonia Vaults |
| 10 | Triple Jump |
| 11 | Single Bomb | 
| 12 | Triple Blomb |
